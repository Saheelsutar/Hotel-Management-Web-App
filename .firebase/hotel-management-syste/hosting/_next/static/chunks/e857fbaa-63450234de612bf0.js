 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function e6(e){let t=ey(e);t._getPasswordPolicyInternal()&&await t._updatePasswordPolicy()}function e5(e,t,i){return(0,n.rh)(e.app)?Promise.reject(g(e)):e9((0,s.m9)(e),eq.credential(t,i)).catch(async t=>{throw"auth/password-does-not-meet-requirements"===t.code&&e6(e),t})}new WeakMap;let e8="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
